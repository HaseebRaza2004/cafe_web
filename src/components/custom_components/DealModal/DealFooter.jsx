    ...
    return (
        <div className="p-4 md:p-6 border-t border-white/10 bg-black/60 backdrop-blur-xl shrink-0 z-10 w-full mt-auto">
            <div className="flex flex-col md:flex-row items-center gap-4">
                ...
                <Button
                    onClick={onAction}
                    className="flex-1 h-12 w-full bg-(--color-gold) text-black hover:bg-[#a68545] font-bold text-sm md:text-base uppercase tracking-widest transition-all hover:scale-[1.02] shadow-[0_0_15px_rgba(197,160,89,0.3)] cursor-pointer"
                >
                    {(isFixedDeal || isLastStep)
                        ? (isEditing
