...
export default function MinimalHeader() {
    return (
        <header className="fixed top-0 left-0 right-0 z-50 h-24 bg-black/40 backdrop-blur-md border-b border-white/10 shadow-xl print:hidden transition-all duration-500">
