    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        <SheetPrimitive.Close
          className="data-[state=open]:bg-secondary absolute top-5 right-5 z-50 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:outline-hidden disabled:pointer-events-none">
